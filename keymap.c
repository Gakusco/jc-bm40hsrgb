...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(3), KC_TRNS, KC_TRNS, KC_PSCR, KC_VOLD, KC_VOLU, KC_MUTE
  ...
  [_TAB] = LAYOUT_planck_mit(
		...
		KC_TRNS, LCTL(KC_7), LCTL(KC_8), LCTL(KC_9), LCTL(KC_R), LCTL(KC_T), KC_TRNS, KC_TRNS, KC_WH_U, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, LCTL(KC_4), LCTL(KC_5), LCTL(KC_6), TO(0), KC_TRNS, KC_TRNS, KC_WH_L, KC_WH_D, KC_WH_R, KC_TRNS, KC_TRNS,
